...
<?php
    $conn = mysqli_init();
    mysqli_real_connect($conn, 'natanon.mysql.database.azure.com', 'NATANON@natanon', 'gG6tbrvqmn', 'natanon.mysql.database.azure.com', 3306);
...
<body>
    <table>
        <tr>
            ...
            <th width="150"> <div align="center">D</div></th>
        </tr>
        <tbody>
        <?php
        $res = mysqli_query($conn, 'SELECT * FROM it63070045');
        ...
        ?>
          <tr id="row<?php echo $Result['ID']; ?>">
            ...
            <td width="150"> <div align="center"><?php echo $Result['D']; ?></div></td>
          </tr>
            <?php
        } mysqli_close($conn);
        ?>
